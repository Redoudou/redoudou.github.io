...
**16+ years** in program management across Web3, aerospace, investment banking, and hospitality.  
**French with Algerian roots**, based in Brooklyn since 2015.
...
| 2021 | Joined ChainSafe to built the consulting department, hired and mentored team of senior TPMs |
| 2020 | Founded Lease On The Block — smart contracts for affordable housing |
...
| Event | Topic |
|-------|-------|
| Singapore Inside Forum | Ethereum Workshop
|SmartCon Chainlink | [The Power of Open Standards](http://content.chainlink.video/smartcon/watch/vtt4ykxBe9jEAabfA6V8Z2?)
| SIBOS Swift Conference| [How Public and Permissioned Networks are Converging](https://www.youtube.com/watch?v=0wArQdOoZEI)
| SEC Crypto Task Force | [Ethereum is the Standard](https://www.sec.gov/files/ctf-memo-erc-3643-association-071625.pdf) |
| EthCC | [Breaking Into the Enterprise Market](https://www.youtube.com/watch?v=ukW0XCwaZ6s) |
| TradFi meets DeFi | [DTCC, JPM, Plume, Chainlink](https://x.com/EntEthAlliance/status/1969157194752147470) |
| 1871 Keynote | [Why Ethereum for Enterprises](https://1871.com/innovation-labs/emerging-tech-summit/) |
| NACHA | [Ethereum Is Open for Business](https://payments.nacha.org/session/ethereum-open-business-how-institutions-are-using-blockchain-real-world) |
| EthDenver @ Circle | How to Build for Enterprises |

### Past

| Event | Topic |
|-------|-------|
| CONSENSUS 2022 | [EIP 3074](https://youtu.be/jHB-k6H5T0k?t=528) |
| TOKEN2049 Singapore | Values in Web3 |
| EthSafari Kenya 2024 | Enterprise Adoption |
| EthToronto 2022 | Mentor & Judge |
| CSCON 2021 | [Cross Chain Messaging](https://www.youtube.com/watch?v=s-f2JJk4Q44&t=35s) |
| IPFS Force 2022 | [Filecoin Substrate Bridge](https://twitter.com/force_ipfs/status/1480879442767474692) |
...
| Project | Link |
|---------|------|
| Web3.js Library Maintenance | [GitHub](https://github.com/web3/web3.js) |
| Polkadot Index Network Token (PINT) | [GitHub](https://github.com/ChainSafe/PINT) |
| Filecoin Substrate Bridge | [GitHub](https://github.com/ChainSafe/filecoindot) |
| Near MetaMask Snap | [GitHub](https://github.com/ChainSafe/near-snap) |
| The Graph Arweave Implementation | [GitHub](https://github.com/graphprotocol/thegarii) |
| API3 Beacon Server (Rust) | [GitHub](https://github.com/ChainSafe/api3-rust) |
| Zcash Web Wallet Feasibility | [Report](https://solutions.chainsafe.io/featured/Publications/Zcash-web-feasibility) |
| Token Drop via Dune & The Graph | [GitHub](https://github.com/ChainSafe/palm-droptics) |
| Polywrap SDK for Substrate | [GitHub](https://github.com/ChainSafe/integrations) |
| W-OTS+ for XXNetwork | [GitHub](https://github.com/ChainSafe/xx-primitives) |
